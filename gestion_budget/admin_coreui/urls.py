...
urlpatterns = [
    ...
    path("search/", views.search_budgets, name="search_budgets"),
    # path("get-data-for-pdf/", views.get_data_for_pdf, name="get_data_for_pdf"),
    ...
    path("data/", views.get_data_to_print, name="get_data_to_print"),
]
